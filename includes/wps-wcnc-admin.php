...
Class WPS_WCNC_Admin{
	...
	public static function add_menu_option(){
	    add_menu_page('Woo Customers Campaign','Woo Customers Campaign','manage_options', 'woo-cust-news-camp-mc-ac', array('WPS_WCNC_Admin', 'customer_list_render_page'),'dashicons-email-alt',55);
	    add_submenu_page('woo-cust-news-camp-mc-ac', 'Settings', 'Settings', 'manage_options','wps-wcnc-settings', array('WPS_WCNC_Admin','settings_render_page'));
	}
							...
							<div class="container">
								<section class="ac-container">
									...
									<div>
										...
										<label for="ac-8">ActiveCampaign</label>
										<?php $settings->display_settings_ActiveCampaign(); ?>
									</div>
								</section>
								<?php 
									submit_button();
	...
	public static function register_settings_fields(){
	    ...
	    /* ActiveCampaign */
	    register_setting("wps-wcnc-api-settings-section", "wps_wcnc_activecampaign_status");
	    register_setting("wps-wcnc-api-settings-section", "wps_wcnc_activecampaign_key");
	    register_setting("wps-wcnc-api-settings-section", "wps_wcnc_activecampaign_url");
	    register_setting("wps-wcnc-api-settings-section", "wps_wcnc_activecampaign_list_id");
