		...
		?>
			<div class="wps-wcnc-actions">
				...
				<form name="wps-wcnc-cust-all-cc" id="wps-wcnc-cust-all-cc" method="POST">
					<input type="hidden" name="action" value="wps_wcnc_camp_all" />
					<input type="hidden" name="wps_wcnc_all_camp_name" value="activecampaign" />
					<input disabled="disabled" id="wps-wcnc-cust-all-cc-btn" class="button button-primary" name="submit" value="ActiveCampaign" type="submit">
				</form>
